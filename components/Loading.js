...
export default function Loading({ spinner = false }) {
  return (
    <Wrapper>
      {!spinner && (
        <>
          ...
          <LoadingParagraph>
            Hi, I’m Luke. I went to the School of Visual Arts and majored in boxing. I started working at a running
            store after graduating and got into running. Somewhere along the way I started doodling about it and posting
            it to Instagram. I run a lot, I draw comics about running, and in my spare time, I read books about running.
            It’s terribly one-dimensional.
          </LoadingParagraph>
          <LoadingDiv />
        </>
      )}
